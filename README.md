...
An OPL3 sound card based on the Yamaha YMF262 and YAC512 ICs.
...
### BOM
The BOM for the board is available here https://electrified.github.io/rcbus-opl3-site/Browse/rcbus-opl3-navigate_Schematic_BoM.htm. The CSV version can be loaded into sites that have BOM upload functionality.

## Configuration
The only configuration on the board is the base address the card is available at
